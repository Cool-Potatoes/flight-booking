...
public enum JwtErrorCode {
  ...
  // 토큰 관련 오류 (UNAUTHORIZED - 401)
  TOKEN_NOT_FOUND(HttpServletResponse.SC_UNAUTHORIZED, "토큰이 존재하지 않습니다."),
